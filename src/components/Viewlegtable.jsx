...
const Viewlegtable = () => {
  ...
  const updatetable = ["Activeleg", "lockleg", "tslleg", "targetleg", "sl", "trail", "target", "timer", "strikeprice", "advice", "spotprice", "ATM", "call", "put", "correction", "sltype", "tsltype", "targettype", "nearestatm", "Linkleg"];
